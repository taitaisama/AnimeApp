...
import 'package:AnimeApp/views/AnimePage.dart';

class AnimeListPage extends StatefulWidget {
  AnimeListPage({Key key, this.str}) : super(key: key);
  final String str;
...
//ok one manga recommendation, read chainsaw man, pretty short and sweet
class _ListState extends State<AnimeListPage> {
  AnimeBlock _bloc;
  String query;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<Response<AnimeList>>(
              ...
              child: InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            ShowAnimeInfo(list.results[index])));
                  },
                  child: SizedBox(
                    height: 65,
                    child: Container(
