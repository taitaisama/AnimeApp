...
import 'package:AnimeApp/views/CharacterPage.dart';

class CharacterListPage extends StatefulWidget {
  CharacterListPage({Key key, this.str}) : super(key: key);
  final String str;
...
class _ListState extends State<CharacterListPage> {
  CharacterBlock _bloc;
  String query;

  @override
  void initState() {
    super.initState();
    _bloc = CharacterBlock(query);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<Response<CharacterList>>(
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: ListView.builder(
              ...
              child: InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            ShowCharacterInfo(list.characters[index])));
                  },
                  child: SizedBox(
                    height: 65,
                    child: Container(
        ...
        itemCount: list.characters.length,
        shrinkWrap: true,
